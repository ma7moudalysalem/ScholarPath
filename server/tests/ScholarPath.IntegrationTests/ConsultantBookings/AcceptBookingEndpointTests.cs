...
public sealed class AcceptBookingEndpointTests : IntegrationTestBase
{
    public AcceptBookingEndpointTests(CustomWebApplicationFactory factory)
        : base(factory)
    {
    }

    [Fact]
    public async Task Post_AcceptBooking_ReturnsNoContent_AndConfirmsBooking()
    {
