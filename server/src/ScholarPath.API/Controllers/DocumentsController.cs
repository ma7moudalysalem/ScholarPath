...
public sealed class DocumentsController(IMediator mediator) : ControllerBase
{
    ...
    public async Task<IActionResult> Upload(
        ...
        [FromForm] Guid? scholarshipProviderReviewRequestId = null,
        CancellationToken ct = default)
    {
        ...
        var result = await mediator.Send(new UploadDocumentCommand(
            stream, file.FileName, file.ContentType, file.Length, category, applicationTrackerId, onboardingType,
            scholarshipProviderReviewRequestId), ct);
