...
public static partial class DbSeeder
{
        ...
        ApplicationDbContext db, DemoUsers users, ILogger logger, CancellationToken ct)
    {
        ...
        var approved = new UpgradeRequest
        {
            ...
            Target = UpgradeTarget.ScholarshipProvider,
        ...
        ILogger logger, CancellationToken ct)
    {
        ...
        var list = new List<Scholarship>
        {
            ...
            new()
            {
                ...
                CategoryId = stem.Id,
                OwnerScholarshipProviderId = globalScholars.Id,
            ...
            new()
            {
                ...
                OwnerScholarshipProviderId = futureFund.Id,
            ...
            new()
            {
                ...
                OwnerScholarshipProviderId = nileBridge.Id,
                Mode = ListingMode.InApp,
                Status = ScholarshipStatus.Open,
            ...
            new()
            {
                ...
                CategoryId = stem.Id,
                OwnerScholarshipProviderId = null,
