        ...
        ApplicationDbContext db, DemoUsers users, ILogger logger, CancellationToken ct)
    {
        ...
        var bookings = new List<ConsultantBooking>
        {
            ...
            new()
            {
                ...
                MeetingUrl = "https://meet.scholarpath.local/booking-confirmed",
            ...
            new()
            {
                ...
                MeetingUrl = "https://meet.scholarpath.local/booking-completed-1",
            ...
            new()
            {
                ...
                MeetingUrl = "https://meet.scholarpath.local/booking-completed-2",
