        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountStatus = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameAr = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageAr = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    UserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    RequestedRole = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    ...
                    ExperienceSummary = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    ExpertiseTags = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    Languages = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ...
                    CompanyCountry = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    CompanyWebsite = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ...
                    ProofDocumentUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: true),
                    UpdatedBy = table.Column<string>(type: "TEXT", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    UserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    FieldOfStudy = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    GPA = table.Column<decimal>(type: "TEXT", precision: 4, scale: 2, nullable: true),
                    Interests = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    Country = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    TargetCountry = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    FieldOfStudy = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    FundingType = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
                    DegreeLevel = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
                    AwardAmount = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: true),
                    Currency = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    Deadline = table.Column<DateTime>(type: "TEXT", nullable: true),
                    EligibilityDescription = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    RequiredDocuments = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    OfficialLink = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ImageUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    MinGPA = table.Column<decimal>(type: "TEXT", precision: 4, scale: 2, nullable: true),
                    MaxAge = table.Column<int>(type: "INTEGER", nullable: true),
                    EligibleCountries = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    EligibleMajors = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    UpgradeRequestId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EducationEntry_UpgradeRequests_UpgradeRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UpgradeRequestLink", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UpgradeRequestLink_UpgradeRequests_UpgradeRequestId",
                        column: x => x.UpgradeRequestId,
                        principalTable: "UpgradeRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    UserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    ScholarshipId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EducationEntry_UpgradeRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UpgradeRequestLink_UpgradeRequestId",
                table: "UpgradeRequestLink",
                column: "UpgradeRequestId");
