...
namespace ScholarPath.Infrastructure.Migrations
{
    ...
    [Migration("20260707031149_AddScholarshipProviderReviewRequestDocuments_PB005")]
    partial class AddScholarshipProviderReviewRequestDocuments_PB005
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.ConsultantAvailability", b =>
                {
                    ...
                    b.HasIndex("ConsultantId", "SpecificStartAt", "IsActive");

                    b.HasIndex("ConsultantId", "DayOfWeek", "StartTime", "IsActive");
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.ConsultantBooking", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ConsultantJoinedAt")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.Document", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("ScholarshipProviderReviewRequestId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ScholarshipProviderReviewRequestId");
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.FinancialConfigRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PaymentType", "Status");

                    b.ToTable("FinancialConfigRules");
                });

            modelBuilder.Entity("ScholarPath.Domain.Entities.ForumBookmark", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.ForumPostTag", b =>
                {
                    b.Property<Guid>("ForumPostId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ForumTagId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.ForumTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.KnowledgeDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.NoShowReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AccusedRole")
                        .IsRequired()
                        .HasMaxLength(16)
                        .HasColumnType("nvarchar(16)");
                    ...
                    b.HasIndex("BookingId", "AccusedUserId")
                        .IsUnique()
                        .HasDatabaseName("UX_NoShowReports_Booking_Accused")
                        .HasFilter("[IsDeleted] = 0");

                    b.ToTable("NoShowReports");
                });
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.PlatformSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.UserProfile", b =>
                {
                    ...
                    b.Property<string>("BookingAccessStatus")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(24)
                        .HasColumnType("nvarchar(24)")
                    ...
                    b.Property<string>("BookingBlockReason")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");

                    b.Property<DateTimeOffset?>("BookingBlockUntil")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("BookingIntakeSuspendedAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<decimal?>("ConsultantAverageRating")
                        .HasPrecision(3, 2)
                        .HasColumnType("decimal(3,2)");

                    b.Property<DateTimeOffset?>("ConsultantLowRatingFlaggedAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<decimal>("ConsultantRatingPenaltyFactor")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(5, 4)
                        .HasColumnType("decimal(5,4)")
                        .HasDefaultValue(1.0m);

                    b.Property<int>("ConsultantReviewCount")
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("IsLegallyRegistered")
                        .HasColumnType("bit");
                    ...
                    b.Property<DateTimeOffset?>("LastOnboardingRejectedAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<string>("LastOnboardingRejectionReason")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<string>("LegalRegistrationNotApplicableReason")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<DateTimeOffset?>("StripeConnectOnboardedAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<string>("StripeConnectStatus")
                        .IsRequired()
                        .HasMaxLength(24)
                        .HasColumnType("nvarchar(24)");

                    b.Property<string>("TaxNotApplicableReason")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.ConsultantBooking", b =>
                {
                    b.HasOne("ScholarPath.Domain.Entities.ConsultantAvailability", "Availability")
                        .WithMany()
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.Document", b =>
                {
                    b.HasOne("ScholarPath.Domain.Entities.ApplicationTracker", "Application")
                        .WithMany()
                        .HasForeignKey("ApplicationTrackerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ScholarPath.Domain.Entities.ApplicationUser", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ScholarPath.Domain.Entities.ScholarshipProviderReviewRequest", null)
                        .WithMany()
                        .HasForeignKey("ScholarshipProviderReviewRequestId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.ForumBookmark", b =>
                {
                    b.HasOne("ScholarPath.Domain.Entities.ForumPost", "ForumPost")
                        .WithMany("Bookmarks")
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.ForumPostTag", b =>
                {
                    ...
                    b.HasOne("ScholarPath.Domain.Entities.ForumTag", "ForumTag")
                        .WithMany("PostTags")
            ...
            modelBuilder.Entity("ScholarPath.Domain.Entities.NoShowReport", b =>
                {
                    b.HasOne("ScholarPath.Domain.Entities.ApplicationUser", "Accused")
                        .WithMany()
                        .HasForeignKey("AccusedUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("ScholarPath.Domain.Entities.ApplicationUser", "Reporter")
                        .WithMany()
