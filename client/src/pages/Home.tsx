...
export default function Home() {
  ...
  const features = [
    ...
    { icon: <TrendingUp />, title: t('home.mentorship'), desc: t('home.featureMentorship') },
    {
      ...
      desc: t('home.featureOpportunities'),
    },
  ];
    ...
    <Box>
      ...
      >
                ...
                {stats.map((stat, i) => (
                  <Box
                    ...
                    sx={{
                      ...
                      borderBottom:
                        i < stats.length - 1 ? `1px solid ${alpha(primary, 0.1)}` : 'none',
                      display: 'flex',
                      alignItems: 'baseline',
        ...
        >
          <Typography
            variant="caption"
            sx={{ letterSpacing: '0.1em', textTransform: 'uppercase', fontSize: '0.65rem' }}
          >
            {t('home.scrollDown')}
          </Typography>
      ...
      <Box sx={{ py: { xs: 9, md: 14 }, bgcolor: bgPaper }}>
        <Container maxWidth="lg">
          <Box sx={{ textAlign: 'center', mb: { xs: 6, md: 10 } }}>
            <Typography
              variant="overline"
              sx={{ color: primary, letterSpacing: '0.15em', mb: 1.5, display: 'block' }}
            >
            ...
            <Typography
              variant="body1"
              sx={{ color: textSecondary, maxWidth: 480, mx: 'auto', lineHeight: 1.7 }}
            >
            ...
            {features.map((feat, i) => (
              <Grid key={i} size={{ xs: 12, sm: 6 }}>
                ...
                >
                  ...
                  <Typography variant="h5" sx={{ color: textPrimary, mb: 1.5 }}>
                    {feat.title}
                  </Typography>
                  <Typography variant="body2" sx={{ color: textSecondary, lineHeight: 1.75 }}>
                    {feat.desc}
                  </Typography>
                </Box>
              </Grid>
      ...
      >
        <Container maxWidth="lg">
          ...
          >
            <Typography
              variant="caption"
              sx={{ letterSpacing: '0.06em', color: 'rgba(255,255,255,0.35)' }}
            >
