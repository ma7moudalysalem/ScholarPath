...
import { analyticsApi, type ScholarshipProviderInsightsDto } from "@/services/api/analytics";
import {
  ChartCard,
  StatCard,
  LegendRow,
...
export function ScholarshipProviderInsights() {
  ...
  const { data, isLoading, isError, refetch } = useQuery<ScholarshipProviderInsightsDto>({
    queryKey: ["analytics", "company", "insights", from, to],
    queryFn: () => analyticsApi.getScholarshipProviderInsights({ from, to }),
  });
  ...
  const countryRows = useMemo<BarRow[]>(
    () =>
      (data?.byCountry ?? []).map((c) => ({
        label: c.country === "Unknown" ? t("analytics:scholarshipProviderInsights.byCountry.unknown") : c.country,
        count: c.count,
    ...
    <div className="space-y-6">
        ...
        <div className="relative z-10 flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl font-bold tracking-tight text-text-primary sm:text-3xl">
              {t("analytics:scholarshipProviderInsights.title")}
            </h1>
            <p className="mt-1 max-w-2xl text-sm text-text-secondary">
              {t("analytics:scholarshipProviderInsights.subtitle")}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
        {isLoading || !data ? (
          ...
          <>
            <StatCard
              label={t("analytics:scholarshipProviderInsights.kpi.totalApplications")}
              value={data.totalApplications}
              icon={ListChecks}
              accent="brand"
            />
            <StatCard
              label={t("analytics:scholarshipProviderInsights.kpi.accepted")}
              value={data.acceptedCount}
              icon={CheckCircle2}
              accent="success"
            />
            <StatCard
              label={t("analytics:scholarshipProviderInsights.kpi.acceptanceRate")}
            ...
            />
            <StatCard
              label={t("analytics:scholarshipProviderInsights.kpi.avgDaysToDecision")}
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <ChartCard
          title={t("analytics:scholarshipProviderInsights.byCountry.title")}
          subtitle={t("analytics:scholarshipProviderInsights.byCountry.subtitle")}
        ...
        <ChartCard
          title={t("analytics:scholarshipProviderInsights.byField.title")}
          subtitle={t("analytics:scholarshipProviderInsights.byField.subtitle")}
      ...
      <ChartCard
        title={t("analytics:scholarshipProviderInsights.topScholarships.title")}
        subtitle={t("analytics:scholarshipProviderInsights.topScholarships.subtitle")}
              ...
              <thead className="text-xs uppercase tracking-wide text-text-tertiary">
                <tr className="border-b border-border-subtle">
                  <th className="px-2 py-2 text-start font-medium">
                    ...
                    >
                      {t("analytics:scholarshipProviderInsights.topScholarships.name")}
                    </button>
                  </th>
                  <th className="px-2 py-2 text-end font-medium">
                    ...
                    >
                      {t("analytics:scholarshipProviderInsights.topScholarships.applications")}
                    </button>
                  </th>
                </tr>
              </thead>
      ...
      <ChartCard
        title={t("analytics:scholarshipProviderInsights.funnel.title")}
        subtitle={t("analytics:scholarshipProviderInsights.funnel.subtitle")}
        trailing={
          <LegendRow
            items={[
              {
                label: t("analytics:scholarshipProviderInsights.funnel.views"),
                colorClass: "text-text-tertiary",
              },
              {
                label: t("analytics:scholarshipProviderInsights.funnel.applied"),
                colorClass: "text-brand-500",
              },
              {
                label: t("analytics:scholarshipProviderInsights.funnel.accepted"),
          ...
          <div className="space-y-4">
            <div className="text-text-tertiary">
              <SmoothAreaChart
                ...
                ariaLabel={t("analytics:scholarshipProviderInsights.funnel.views")}
              />
            </div>
            <div className="text-brand-500">
              <SmoothAreaChart
                ...
                labels={monthlyLabels}
                ariaLabel={t("analytics:scholarshipProviderInsights.funnel.applied")}
              />
            </div>
            <div className="text-success-500">
              <SmoothAreaChart
                ...
                labels={monthlyLabels}
                ariaLabel={t("analytics:scholarshipProviderInsights.funnel.accepted")}
              />
            </div>
          </div>
        )}
