...
// Roles a user can hold simultaneously and switch between. SuperAdmin doesn't
// show in the switcher because it's only ever held alongside Admin and they
// share the same dashboard.
const SWITCHABLE_ROLES = ["Student", "Consultant", "Company", "Admin"] as const;

/**
 * Top-right profile dropdown — name/email/active role, role switching for
 * dual-role accounts (FR-ONB-10), Profile link, and Sign out. Built on the
 * Radix DropdownMenu so keyboard nav and ARIA come for free.
 */
